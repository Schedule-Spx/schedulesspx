              ...
              element={
                user ? (
                  <main className="p-4 flex flex-col space-y-4 content-wrapper">
                    ...
                    <div className={`w-full ${currentTheme.accent} ${currentTheme.border} rounded-lg shadow-md overflow-hidden period-progress-container slide-up`} style={{ height: '160px' }}>
