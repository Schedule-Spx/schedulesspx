...
const Account = ({ user, weekSchedule }) => {
  ...
  return (
    <div className="container mx-auto mt-8 p-4 flex flex-col min-h-screen">
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 mb-8 flex-grow">
        <h2 className="text-xl font-bold mb-4">Customize Period Names</h2>
        <PeriodRenamer weekSchedule={weekSchedule} />
      </div>

      <div className="bg-white dark:bg-gray-800 rounded-lg shadow-lg p-6 mt-auto">
